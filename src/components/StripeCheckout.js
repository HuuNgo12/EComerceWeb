    ...
    return (
        <div>
            {succeeded ? (
                <article>
                    <h4>Thank You </h4>
                    <h4>Your payment was succeessful!</h4>
            ...
            <form id="payment-form" onSubmit={handleSubmit}>
                ...
                {/* show any error message that happens when prcessing the payment */}
                {error && (
                    <div className="card-error" role="alert">
                        {error}
                    </div>
                )}
                {/* show a success message upon complete*/}
                <p
                    className={
